...
ROBOT_RADIUS = 2.0  # robot radius [m]  #insert robot dimensions
...
#longitudnal tracjectory planning 
...
def calc_frenet_paths(c_speed, c_accel, c_d, c_d_d, c_d_dd, s0):
    ...
    for di in np.arange(-MAX_ROAD_WIDTH, MAX_ROAD_WIDTH, D_ROAD_W):
        ...
        for Ti in np.arange(MIN_T, MAX_T + DT, DT):
            fp = FrenetPath()
